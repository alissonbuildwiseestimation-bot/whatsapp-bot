...
async function testNavyPostLinks() {
    const url = 'https://vegamovies.navy/download-deadpool-dual-audio-hindi-480p-720p-1080p/';
    ...
    try {
        ...
        $('a[href]').each((_, el) => {
            ...
            // Let's traverse up and find preceding headings/text to guess resolution/description
            ...
            links.push({ text: linkText, href, resolution, heading: precedingHeading.trim() });
        });
